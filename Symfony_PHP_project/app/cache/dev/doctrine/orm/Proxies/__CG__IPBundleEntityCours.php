 ...
 */
class Cours extends \IPBundle\Entity\Cours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'IPBundle\\Entity\\Cours' . "\0" . 'id', '' . "\0" . 'IPBundle\\Entity\\Cours' . "\0" . 'nom', '' . "\0" . 'IPBundle\\Entity\\Cours' . "\0" . 'chapitres', '' . "\0" . 'IPBundle\\Entity\\Cours' . "\0" . 'notes');
        }
    ...
    public function setChapitres($chapitres)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setChapitres', array($chapitres));
