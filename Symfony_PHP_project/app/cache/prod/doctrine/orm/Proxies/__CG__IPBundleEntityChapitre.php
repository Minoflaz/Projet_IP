 ...
 */
class Chapitre extends \IPBundle\Entity\Chapitre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'IPBundle\\Entity\\Chapitre' . "\0" . 'id', '' . "\0" . 'IPBundle\\Entity\\Chapitre' . "\0" . 'nom', '' . "\0" . 'IPBundle\\Entity\\Chapitre' . "\0" . 'text', '' . "\0" . 'IPBundle\\Entity\\Chapitre' . "\0" . 'cours');
        }
